...
# v0.4 if texturename starts with number, it adds "_" before it.
...
def on_button_clicked(*args):
    ...
    for material in allMaterials:
        ...
        if file_node:
            ...
            if texture_name[0].isdigit():
                texture_name = "_" + texture_name
            try:
...
cmds.text( label='v0.4', align='right', font = "smallObliqueLabelFont")
